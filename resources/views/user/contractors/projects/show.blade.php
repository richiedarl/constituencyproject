                            ...
                            <div class="col-md-9">
                                <div class="timeline-content card border-0 bg-light">
                                    <div class="card-body">
                                        ...
                                        {{-- Upload Media Only for Latest Active Phase --}}
                                        @if(isset($latestPhase) && $latestPhase->id === $phase->id)
                                            <div class="mt-4 border-top pt-4">
                                                <h6 class="mb-3">
                                                    <i class="fas fa-upload me-2 text-primary"></i>
                                                    Upload Media to Current Phase
                                                </h6>

                                                <form action="{{ route('contractor.phase.media.store', $phase) }}"
                                                      method="POST"
